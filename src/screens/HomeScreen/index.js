    ...
    return (
        <>
            ...
            <View style={{ flex: 1, marginTop: statusBarHeight, padding: 30, flexDirection: 'column', justifyContent: 'space-between', }}>
                ...
                <HomeButtonContainer>
                    <HomeButton bgColor="indigo" text="Show your all scores" iconName='activity' func={goToScoresScreen} />
                </HomeButtonContainer>

                <HomeButtonContainer>
                    <HomeButton bgColor="mediumseagreen" text="Show ratings" iconName='trending-up' func={goToRatingsScreen} />
                </HomeButtonContainer>

                <HomeButtonContainer>
                    <HomeButton bgColor="mediumblue" text="Sign Out" iconName='log-out' func={() => auth().signOut()} />
                </HomeButtonContainer>
            </View>
        </>
    );
